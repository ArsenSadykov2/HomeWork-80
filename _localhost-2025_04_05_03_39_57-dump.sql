...
--
-- Host: 127.0.0.1    Database: HomeWork80-api
-- ------------------------------------------------------
...
DROP SCHEMA IF EXISTS `HomeWork80-api`;
CREATE SCHEMA `HomeWork80-api`;
USE `HomeWork80-api`;
...
INSERT INTO `categories` VALUES (1,'Бытовая техника','Современная, надежная техника'),(2,'Компьютерная техника',NULL),(3,'Мебель','Фирменная мебель из натуральных материалов');
